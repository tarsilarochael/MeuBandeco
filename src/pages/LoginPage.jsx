...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Simula o tempo de resposta da IU CEFET-MG [cite: 142, 262]
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      const loginLimpo = matricula.toLowerCase().trim();

      // Lógica de Diferenciação de Acesso
      if (loginLimpo === 'nutri') {
        // Acesso exclusivo Nutricionista [cite: 149, 212]
        setTentativas(0);
        navigate('/nutricionista');
      } else {
        // Acesso Aluno/Servidor (aceita qualquer outra matrícula por enquanto) [cite: 203]
        setTentativas(0);
        navigate('/home');
      }
  ...
  // O restante do componente (JSX, return e estilos) permanece EXATAMENTE igual ao seu código original
  return (
        ...
        <div className="p-8 pt-6">
          {activeTab === 'login' && (
            <div className="animate-fadeIn">
              <p className="text-center text-gray-700 text-base mb-6">Acesse com sua Identificação Única</p>
              <form onSubmit={handleSubmit} className="space-y-5 max-w-md mx-auto" noValidate>
                <div>
                  <label htmlFor="matricula" className="block text-base font-semibold text-gray-800 mb-2">Matrícula / CPF</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Digite 'nutri' ou sua matrícula"
                      value={matricula}
                ...
                <div>
                  <label htmlFor="senha" className="block text-base font-semibold text-gray-800 mb-2">Senha Institucional</label>
                  <div className="relative">
                    <span className="absolute left-3 top-3.5 text-gray-600">🔒</span>
                    <input
                      id="senha"
          ...
          {activeTab === 'cardapio' && (
            <div className="animate-fadeIn">
              <div className="bg-blue-50 border-2 border-blue-300 rounded-xl p-5 mb-6">
                <p className="font-bold text-blue-900 text-lg">Cardápio Público [cite: 308, 317]</p>
